...
import { SidebarSectionComponent } from '../ui/sidebar-section/sidebar-section.component';
...
@Component({
  ...
  imports: [RouterLink, LucideAngularModule, SidebarItemComponent, SidebarSectionComponent, ConfirmRemoveFolderDialogComponent],

...
pub use crate::library::models::DbImage;

pub use crate::pipeline::queue::{
    enqueue_image, get_queue_batch, mark_semantic_analysis_done, mark_subject_analysis_done,
    mark_failed, get_processing_counts,
};
...
pub use crate::people::repo::{
    insert_subject, insert_face, list_all_subjects, list_faces_for_subject, get_face_by_id,
    update_subject_name, update_subject_thumbnail_face, get_subject_detail_with_counts,
    list_images_for_subject, get_largest_face_for_subject, list_faces_for_image,
    get_face_with_image, get_unassigned_faces_with_embeddings, update_face_subject,
    delete_subjects_with_no_faces, auto_assign_missing_thumbnails, upgrade_subject_thumbnails,
    clear_merge_suggestions, insert_merge_suggestion, get_merge_suggestions, merge_subjects,
    get_dismissed_pair_set, dismiss_merge_suggestion, find_subject_by_name,
    assign_face_to_subject, create_subject_for_face,
    add_must_link, add_cannot_link, upsert_face_edge, clear_all_face_edges,
    get_all_similarity_edges, get_all_must_link_pairs, get_all_cannot_link_pairs,
    get_assigned_face_subject_map, get_face_ids_for_subject, get_all_face_ids_with_vectors,
    unassign_face, reset_all_subject_data,
};

pub use crate::tags::repo::{
    create_tag, add_subject_tag, remove_subject_tag, get_subject_tags, list_tags_with_counts,
    rename_tag, delete_tag, get_tag_image_ids_ordered, search_subjects_matching,

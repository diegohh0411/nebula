...
pub const SIGLIP_FAST: ModelSpec = ModelSpec {
    ...
    model_file: ModelFile {
        ...
        remote_path: Some("onnx/vision_model_quantized.onnx"),
    },
    tokenizer_file: Some(ModelFile {
        filename: "tokenizer.json",
        remote_path: None,
    }),
    display_name: "Blitz",
    display_description:
        "Faster search with a small quality tradeoff. Good for large libraries and slower hardware.",
    image_size: 256,
    vision_file: Some(ModelFile {
        filename: "vision_model_quantized.onnx",
        remote_path: Some("onnx/vision_model_quantized.onnx"),
    }),
    text_file: Some(ModelFile {
        filename: "text_model_quantized.onnx",
        remote_path: Some("onnx/text_model_quantized.onnx"),
    }),
...
pub const SIGLIP_BASE: ModelSpec = ModelSpec {
    ...
    model_file: ModelFile {
        ...
        remote_path: Some("onnx/vision_model.onnx"),
    },
    tokenizer_file: Some(ModelFile {
        filename: "tokenizer.json",
        remote_path: None,
    ...
    text_file: Some(ModelFile {
        ...
        remote_path: Some("onnx/text_model.onnx"),
    }),
    vision_input: "pixel_values",
    vision_output: "pooler_output",
    text_input: "input_ids",
...
pub const BUFFALO_S_RECOGNITION: ModelSpec = ModelSpec {
    ...
    model_file: ModelFile {
        ...
        remote_path: Some("recognition/model.onnx"),
    },
    tokenizer_file: None,
...
pub const BUFFALO_S_DETECTION: ModelSpec = ModelSpec {
    ...
    model_file: ModelFile {
        ...
        remote_path: Some("detection/model.onnx"),
    },
    tokenizer_file: None,
...
pub const BUFFALO_S_GENDER_AGE: ModelSpec = ModelSpec {
    ...
    model_file: ModelFile {
        ...
        remote_path: Some("models/buffalo_l/genderage.onnx"),
    },
    tokenizer_file: None,
...
pub const ALL_MODELS: &[&ModelSpec] = &[
    ...
    &ANTELOPE_V2_DETECTION,
    &ANTELOPE_V2_RECOGNITION,
];
...
mod tests {
    ...
    fn blitz_smart_search_model_is_first_and_named_correctly() {
        ...
        assert_eq!(
            first.id, "onnx-community/siglip2-base-patch32-256-ONNX",
            "SIGLIP_FAST (Blitz) must be first"
        );
    ...
    fn all_presets_are_registered_and_findable() {
        ...
        assert!(
            FaceIdPreset::find_by_id("quality").is_none(),
            "quality preset must be removed"
        );
    ...
    fn buffalo_l_models_not_in_all_models() {
        ...
        assert!(
            !ids.contains(&"buffalo_l_detection"),
            "buffalo_l must be removed"
        );
        assert!(
            !ids.contains(&"buffalo_l_recognition"),
            "buffalo_l must be removed"
        );
